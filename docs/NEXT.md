...
| 6 | Physical-validation plan | First board, printer/material profile, and fit checks named | Validation plan document or ADR |
| 7 | Smallest implementation slice | A basic calibrated board outline and two mounting holes can save/load and validate | Host/UI tests appropriate to selected stack |
